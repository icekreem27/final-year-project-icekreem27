...
rolling_window_size = 50  # Defines the smoothing window
...
valid_metrics['valid_loss_rolling_mean'] = valid_metrics['valid_loss'].rolling(window=2).mean()  # Smaller window due to fewer data points
